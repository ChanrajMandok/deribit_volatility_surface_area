...
class ObserverIndicatorAnnualisedReturnSpread(ObserverInterface):
    ...
    def update(self):
        self.__indicator_annualised_return_spread = self.indicator_annualised_return_spread_builder.build()
        if self.__indicator_annualised_return_spread is None:
            return
        print(f"{self.__indicator_annualised_return_spread.key}: {self.__indicator_annualised_return_spread.value}:{self.__indicator_annualised_return_spread.amount}")
