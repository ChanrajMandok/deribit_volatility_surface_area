from deribit_arb_app.store.store_observable_interface import \
                                      StoreObservableInterface
...
from deribit_arb_app.store.store_subscribable_interface import \
                                      StoreSubscribableInterface
...
class Stores:
    ...
    store_observable_instrument_list            = StoreObservableInterface[str, ModelObservableInstrumentList]()
