...
from deribit_arb_app.model.model_indicator_implied_volatilty import ModelIndicatorImpliedVolatility
from deribit_arb_app.services.service_pricer_black_scholes import ServicePricerBlackScholes
...
class ServiceImpliedVolatilityBsmBuilder:
    ...
    def __init__(self, indicator_implied_volatility: ModelIndicatorImpliedVolatility):
    ...
    def build(self) -> Optional[ModelIndicatorImpliedVolatility]:
